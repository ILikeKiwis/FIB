/****************************************************************************
** Meta object code from reading C++ file 'S2_drawSmooth.h'
**
...
#include <memory>
#include "../S2_drawSmooth.h"
#include <QtCore/qmetatype.h>
#include <QtCore/qplugin.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'S2_drawSmooth.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Draw_smooth_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Draw_smooth_t qt_meta_stringdata_Draw_smooth = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Draw_smooth[] = {
...
Q_CONSTINIT const QMetaObject Draw_smooth::staticMetaObject = { {
    ...
    qt_meta_stringdata_Draw_smooth.offsetsAndSizes,
    qt_meta_data_Draw_smooth,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Draw_smooth_t,
        // Q_OBJECT / Q_GADGET
