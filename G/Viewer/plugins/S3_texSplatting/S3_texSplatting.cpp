...
void S3_texSplatting::onPluginLoad()
{
    cout << "Aqui tamos" << endl;
    GLWidget &g = *glwidget();
    g.makeCurrent();
	// VS
    QString vs_src = \
    ...
    QString fs_src =
      ...
      "                 texture(sampler1, vtexCoord), texture(sampler2, vtexCoord).r); }";
...
void S3_texSplatting::postFrame() 
{
    GLWidget &g = *glwidget();
    g.makeCurrent();
