...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_AlphaBlending_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_AlphaBlending_t qt_meta_stringdata_AlphaBlending = {
    {
        QT_MOC_LITERAL(0, 13)   // "AlphaBlending"
    },
    "AlphaBlending"
};
...
Q_CONSTINIT static const uint qt_meta_data_AlphaBlending[] = {
...
Q_CONSTINIT const QMetaObject AlphaBlending::staticMetaObject = { {
    ...
    qt_meta_stringdata_AlphaBlending.offsetsAndSizes,
    qt_meta_data_AlphaBlending,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_AlphaBlending_t,
        // Q_OBJECT / Q_GADGET
