...
class gVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by gParser#Com.
    def visitCom(self, ctx:gParser.ComContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by gParser#AsExpr.
    def visitAsExpr(self, ctx:gParser.AsExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by gParser#NormalExpr.
    def visitNormalExpr(self, ctx:gParser.NormalExprContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by gParser#comment.
    def visitComment(self, ctx:gParser.CommentContext):
        return self.visitChildren(ctx)
